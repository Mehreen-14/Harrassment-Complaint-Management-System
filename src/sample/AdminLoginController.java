...
public class AdminLoginController  extends Main implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        showpass.selectedProperty().addListener((ObservableValue<? extends Boolean> ov,Boolean old_val, Boolean new_va)->{
